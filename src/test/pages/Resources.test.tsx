...
describe("Resources page", () => {
    ...
    it("renders core resource card titles", () => {
        renderWithRouter(<ResourcesPage />);
        ...
        expect(screen.getByText("Club LinkTree")).toBeInTheDocument();
    });
    ...
    it("links AWS Skill Builder card to correct external URL", () => {
        renderWithRouter(<ResourcesPage />);
        const link = screen.getByRole("link", { name: /Explore Skill Builder/i });
    ...
    it("links Club LinkTree card to correct external URL", () => {
        renderWithRouter(<ResourcesPage />);
